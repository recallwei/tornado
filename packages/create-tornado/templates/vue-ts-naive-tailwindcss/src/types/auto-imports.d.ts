...
declare global {
  ...
  const effectScope: (typeof import('vue'))['effectScope']
  const faviconLoader: (typeof import('../tools/faviconLoader'))['faviconLoader']
  ...
  const naiveUILoader: (typeof import('../tools/naiveUILoader'))['naiveUILoader']
  ...
  const siteMetaData: (typeof import('@/constants'))['siteMetaData']
  ...
  const useCounterStore: (typeof import('../store/counter/index'))['useCounterStore']
